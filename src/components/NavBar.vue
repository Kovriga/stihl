<template>
  <div class="nav-bar--main">
    <div class="nav-bar--header-left">
      ...
      <a href="#"> AKKU </a>
      <a href="#"> АКЦИИ </a>
      <a href="#"> ПОИСК ДИЛЛЕРОВ </a>
      <a href="#"> НОВОСТИ </a>
      <a href="#"> О НАС </a>
      <a href="#"> КОНТАКТЫ </a>
    </div>
    <div class="nav-bar--header-right">
    </div>
  </div>
</template>
